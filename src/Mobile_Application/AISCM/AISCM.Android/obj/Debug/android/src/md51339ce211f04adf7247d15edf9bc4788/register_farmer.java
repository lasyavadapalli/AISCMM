...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AISCM.Droid.register_farmer, AISCM.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", register_farmer.class, __md_methods);
	}


	public register_farmer () throws java.lang.Throwable
	{
		super ();
		if (getClass () == register_farmer.class)
			mono.android.TypeManager.Activate ("AISCM.Droid.register_farmer, AISCM.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

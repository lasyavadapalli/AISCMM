...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AISCM.Droid.Login, AISCM.Android", Login.class, __md_methods);
	}
	...
	public Login ()
	{
		...
		if (getClass () == Login.class)
			mono.android.TypeManager.Activate ("AISCM.Droid.Login, AISCM.Android", "", this, new java.lang.Object[] {  });
	}
